...
(function (d) {
	d.fn.ClassyLoader = function (a) {
		a = d.extend({}, {
			...
			remainingLineColor: "rgba(212, 212 ,212, 1)",
			lineWidth: 10,
			start: "left"
		}, a);
		var e = d(this);
		this.draw = function (b) {
			...
			var c = e[0].getContext("2d"), h = e.width() / 2, d = e.height() /
				2, f = 0, g = 0;
			c.scale(2, 2);
			...
			setTimeout(function k() {
				...
				c.stroke();
				c.closePath();
				!0 === a.showText && (c.fillStyle = a.fontColor, c.font = ("" !== a.fontStyle ? a.fontStyle + " " : "") + a.fontSize + " " + a.fontFamily, c.textAlign = "center", c.textBaseline = "middle", c.fillText(f + 1 + "%", h, d));
				f += 1;
		...
		this.show = function () {
			...
			b.stroke();
			b.closePath();
			!0 === a.showText && (b.fillStyle = a.fontColor, b.font = ("" !== a.fontStyle ? a.fontStyle + " " : "") + a.fontSize + " " + a.fontFamily, b.textAlign = "center", b.textBaseline = "middle", b.fillText(a.percentage + "%", c, d));
			!0 === a.showRemaining && (b.beginPath(), b.strokeStyle = a.remainingLineColor, b.arc(c, d, a.diameter,
				0, 360), b.stroke(), b.closePath())
		};
